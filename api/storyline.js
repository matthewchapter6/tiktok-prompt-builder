...
export default async function handler(req, res) {
  ...
  try {
    ...
    const langGuide = {
      zh: 'IMPORTANT: Respond entirely in Simplified Chinese (简体中文). All titles, descriptions, hooks and emotions must be in Chinese.',
      bm: 'IMPORTANT: Respond entirely in Bahasa Malaysia. All titles, descriptions, hooks and emotions must be in Bahasa Malaysia.',
